  ...
  footer: `  <footer class="site-footer" id="contact" data-cursor-zone="cross">
    ...
    <div class="site-footer__box">
      ...
      <div class="site-footer__cta">
        <h2 class="site-footer__heading" data-reveal>We can work together, yunno?</h2>
        <a class="pill site-footer__button" href="mailto:me@sammiee.dev?subject=Let%E2%80%99s%20create%20magic"
           data-contact-open data-magnetic="0.28" data-cursor-tag="Say hello" data-cursor-color="#edaa0b">
          <span class="pill__label">Let&rsquo;s create Magic!</span>
        </a>
      </div>
    ...
    <p class="site-footer__fineprint">
      &copy; 2026 Sammiee. Designed and built by me, one page at a time.
    </p>
  </footer>`,
}
